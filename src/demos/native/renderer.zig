...
// const nmath = @import("../src/core/nmath.zig");
const nmath = zigics.nmath;
const Vector2 = nmath.Vector2;
const Solver = zigics.Solver;
const fg_mod = zigics.forcegenerator_module;
const rb_mod = zigics.rigidbody_module;
// const fg_mod = @import("../src/core/force_generator.zig");
// const rb_mod = @import("../src/core/rigidbody.zig");
const rl = @import("raylib");
const RigidBody = rb_mod.RigidBody;
const ctr_mod = zigics.constraint_module;
// const ctr_mod = @import("../src/core/constraint.zig");
